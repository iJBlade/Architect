                ...
                <div>
                    <?php  foreach ($ligne as $produit){ ?>
                            ...
                            <div style="position: absolute;top: 70%;width: 1623px;margin : 0 auto;left: 9%;">
                                ...
                                <div>
                                    <div>
                                        <p id="Up"><?= htmlentities($produit->getPrix())?>€ <a id="b3">Modifier le prix</a></p><!-- titre  contenu-->                                  
                                ...
                                <div>
                                    <div>
                                        <p id="Up"><?= htmlentities($produit->getTva())?>% <a id="b4">Modifier la Tva</a></p><!-- titre  contenu-->                             
