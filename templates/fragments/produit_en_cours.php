...
<h1 style="padding: 22px 0px;background: darkgoldenrod;color: white;margin: 2px 0px;">Produits hors ligne : </h1>
    <?php  foreach ($tab as $produit){ ?>
                <div>                   
                        <figure class="snip1584">
                            ...
                            </figcaption><a href="dashboard_offline.php?prod=<?=$produit->getId()?>"></a>
                        </figure>
                </div>   
    <?php } ?>                
</div> 
